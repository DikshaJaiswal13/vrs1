...
<body>
	...
	<div class="collapse navbar-collapse" id="navbarColor01">
		<ul class="navbar-nav mr-auto">
			<li class="nav-item"><a class="nav-link" href="/Vehicle_Reservation_System/homeAgain">Home</a></li>
			<li class="nav-item"><a class="nav-link" href="/Vehicle_Reservation_System/create">Create</a></li>
			<li class="nav-item"><a class="nav-link" href="/Vehicle_Reservation_System/search">Search</a></li>
			<li class="nav-item"><a class="nav-link" href="/Vehicle_Reservation_System/list">List</a></li>
		</ul>
	</div>
	<form action="#">
